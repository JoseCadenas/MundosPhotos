...
const messages = {
  "en-US": {
    ...
    emailSentMessage:
      "Your message has been sent. Thank you for your interest. We will respond as soon as possible.",
    rules: {
      input: "Please enter something.",
      select: "Please select an option. | Please select two or more options.",
      date: "Please select a date.",
      passwordMustBeAtLeastNumberCharacters: ({ number = 6 }) =>
  ...
  "es-MX": {
    ...
    emailSentMessage:
      "Tu mensaje ha sido enviado. Gracias por su interés. Responderemos lo antes posible.",
    rules: {
      input: "Por favor ingrese algo.",
      select:
        "Por favor seleccione una opción. | Seleccione dos o más opciones.",
      date: "Seleccione una fecha.",
      passwordMustBeAtLeastNumberCharacters: ({ number = 6 }) =>
        `La contraseña debe tener al menos ${number} caracteres.`,
    },
    success: {},
    warnings: {},
    errors: {
      ...
      general: "@:errors.somethingWentWrong @:errors.pleaseTryAgain",
      emailAlreadyInUse:
        "Correo electrónico ya en uso, por favor inicie sesión.",
